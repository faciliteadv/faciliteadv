                    ...
                    {sortedTasks.length === 0 ? (
                        ...
                        sortedTasks.map((task) => (
                            ...
                            >
                                ...
                                {/* Process */}
                                <div className="col-span-2 flex items-center min-w-0 overflow-hidden">
                                    {task.process ? (
                                        <div className="flex items-center gap-1.5 min-w-0 max-w-full">
                                            <FileText className="w-3 h-3 text-slate-400 shrink-0" />
                                            <span className="text-xs text-slate-600 font-mono truncate" title={task.process.folderName || task.process.number}>
